...
class Admin::ContentController < Admin::BaseController
	...
	def merge
		...
		@merge_with = Article.find_by_id(params[:merge_with])

		#checking admin privellages
		unless current_user.admin?
			redirect_to admin_content_path
			flash[:error] = "You do not have permission to merge articles!"
			return
		end

		#ensuring the article exists
		unless @merge_with
			redirect_to admin_content_path
